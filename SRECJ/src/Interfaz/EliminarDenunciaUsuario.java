 ...
 * @author rosco
 */
public class EliminarDenunciaUsuario extends javax.swing.JPanel {
     ...
     */
    public EliminarDenunciaUsuario() {
        initComponents();
    ...
    private void jListDenunciasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jListDenunciasMouseClicked
        ...
        if (evt.getClickCount() == 2 && evt.getButton() == MouseEvent.BUTTON1) {
                int response = JOptionPane.showConfirmDialog(this, "¿Estas seguro que deseas eliminar esta denuncia?", "Elimar Denuncia", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
