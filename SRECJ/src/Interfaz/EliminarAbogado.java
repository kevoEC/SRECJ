 ...
 * @author rosco
 */
public class EliminarAbogado extends javax.swing.JPanel {
     ...
     */
    public EliminarAbogado() {
        initComponents();
        jListABG.setModel(dlm);
    }

    public void Listar1(String tipo) {
        dlm.removeAllElements();
        for (Usuario asuarioab : lt.obtenerTodos()) {
    ...
    private void initComponents() {
        ...
        jListABG = new javax.swing.JList<>();
        ...
        Title.setText("Eliminar abogado del CIDHU");
        ...
        jLabel2.setText("Tu como presidente puedes eliminar a un mienbro del CIDHU");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 110, -1, -1));

        jListABG.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jListABGMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(jListABG);
    ...
    private void btnMostrarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnMostrarMouseClicked
        ...
        if (!lt.esVacia()) {
            ...
            JOptionPane.showMessageDialog(null, "ACTUALMENTE NO EXISTEN ABOGADOS ACTIVOS EN EL CIDHU");
        }
    ...
    private void jListABGMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jListABGMouseClicked
        // TODO add your handling code here:
        MenuUsuario mn = new MenuUsuario();
        if (evt.getClickCount() == 2 && evt.getButton() == MouseEvent.BUTTON1) {
            int response = JOptionPane.showConfirmDialog(this, "¿Estas seguro que deseas eliminar esta denuncia?", "Elimar Abogado", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
            if (response == JOptionPane.YES_OPTION) {
               lt.remove(jListABG.getSelectedIndex());
                dlm.removeAllElements();
                ArrayList<Usuario> listado = lt.obtenerTodos();
    ...
    }//GEN-LAST:event_jListABGMouseClicked
...
void setColor(JPanel panel) {
    ...
    private javax.swing.JList<String> jListABG;
